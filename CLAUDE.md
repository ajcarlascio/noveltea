...
Greenfield — nothing is scaffolded. This repository currently contains its founding
documents and nothing else. Paths, module names and commands below describe the *intended*
layout; check that a thing exists before relying on it, and prefer extending this file over
...
None of these exist yet. When scaffolding, prefer these names over inventing new ones:
...
npm run build
npm test                   # unit tests
npm test -- src/sync       # one directory
